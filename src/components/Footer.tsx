              ...
              <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px] -mt-24">
                ...
                <div className="lg:col-span-3 md:col-span-4">
                  ...
                  <div className="flex mt-6">
                    <MapPin className="w-5 h-5 text-green-600 ltr:mr-3 rtl:ml-3" />
                    <div className="">
                    ...
                    <div className="flex mt-6">
                      <Mail className="w-5 h-5 text-green-600 ltr:mr-3 rtl:ml-3" />
                      <div className="">
                    ...
                    <div className="flex mt-6">
                      <Phone className="w-5 h-5 text-green-600 ltr:mr-3 rtl:ml-3" />
                      <div className="">
